...
features.
  ...
  \bottomrule
  \end{tabularx}
  \captionof{table}{Specifications. RF represents required features. OF
  represents optional features, which will only be implemented if the enough
  time\label{table:specs}}
